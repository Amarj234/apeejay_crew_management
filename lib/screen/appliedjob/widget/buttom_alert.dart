      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: <Widget>[
            ...
            Row(
              children: [
                ...
                Container(
                  ...
                  child: Text(jobs.job?.jobType??"",style: style16w500b,),
                ),
              ],
            ),
            const SizedBox(height: 15,),
            ...
            Text(
               jobs.job?.description??"",  style: GoogleFonts.roboto(
            ...
            const SizedBox(height: 7,),
            for(int i=0;i<jobs.job!.eligibility!.split("\r\n-").length;i++)...[
              dotText(jobs.job!.eligibility!.split("\r\n-")[i],context),
            ],
            ...
            Container(
              ...
              child: Text("Application Deadline: ${difrent2(jobs.job!.lastApplyDate.toString())}",style: style14w400b,),
            ),
